...
const UserInput = (props) => {
  ...
  return (
    <div className="pageContainer">
      ...
      <FormControl
        variant="filled"
        className="Input-formcontrol-style"
        margin="normal"
      >
        ...
        <Select
          ...
          onChange={(event) => {
            setCowOrHeifer(event.target.value);
          }}
        >
      ...
      <FormControl variant="filled" className="Input-formcontrol-style">
        ...
        <Select
          ...
          onChange={(event) => {
            setSemenType(event.target.value);
          }}
        >
      ...
      <InputLabel>
        <strong>Date and Time to Start Breeding</strong>
      </InputLabel>
      <br />
      ...
      <FormControl variant="filled" className="Input-formcontrol-style">
        ...
        <input
          ...
          onChange={(event) => {
            setBullTurnIn(event.target.value);
          }}
        />
      </FormControl>
      <br />
      ...
      <FormControl variant="filled" className="Input-formcontrol-style">
        ...
        <input
          ...
          onChange={(event) => {
            setGestationPeriod(event.target.value);
          }}
        />
      </FormControl>
      <br />
