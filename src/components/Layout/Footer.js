      ...
      <Container maxWidth="md" sx={{ py: 1 }}>
        ...
        <center>
          <Typography
            variant="caption"
            align="center"
            className="copyright-footer-loc"
          >
            Copyright &copy; 2022 Beef Reproduction Task Force
          </Typography>
        </center>
      </Container>
    </Box>
